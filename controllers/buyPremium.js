...
exports.getReportFile = (req, res) =>{
         ...
         const userId = req.user.id;
          ...
          .then(( result) =>{
            ...
            incomes.findAll({where:{userId : userId}})
            .then( (incomeResult) =>{
                 ...
                 .then((userReult)=>{
                       res.status(200).json({Expenses: result, Incomes: incomeResult, total: userReult})
...
exports.getReportFilePage = (req,res) =>{
          res.sendFile(path.join(__dirname,'../','public','views','reportFile.html'));
